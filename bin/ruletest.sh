...
RULES="argus arpwatch asterisk avahi bro-ids bsd_kernel bsd clamav cvsyncd dbus ddclient dropbear flowd ftpd hp identd irqbalance isakmpd linux_kernel mountd named ntpd ossec osx pam portsentry pulseaudio python samba sensorsd smartd smtpd snmpd sshd su syslogd vmware-esxi"
