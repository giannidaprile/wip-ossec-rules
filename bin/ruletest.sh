...
RULES="arpwatch avahi bsd_kernel clamav cvsyncd dbus ddclient dropbear flowd hp identd irqbalance isakmpd linux_kernel mountd named ntpd pam pulseaudio python samba sensorsd smartd smtpd smtpd snmpd sshd su"
